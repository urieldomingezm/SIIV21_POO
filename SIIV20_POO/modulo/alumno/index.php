                ...
                <div class="col-lg-10">
                    ...
                    if (isset($_GET['q']) && !empty($_GET['q'])) {
                        ...
                        if (isset($_GET['page'])) {
                            $page = $_GET['page'];
                            $validPages = [
                                'home' => ['file' => 'GSTM.php', 'roles' => ['alumno', 'docente', 'personal', 'aspirante']],
    ...
    <body>
        ...
        <style>
            ...
            .loader-image {
                ...
                z-index: 2;
                animation: none;
                /* Asegura que la imagen no tenga animación */
                transform: none;
                /* Previene cualquier transformación */
            }
