<div class="content" id="Aspirantes">
    <div class="row">
        <!-- Columna izquierda: Proceso de Admisión -->
        <div class="col-md-6">
            <div class="content" id="ProcesoAdmision">
                <div class="accordion accordion-flush" id="accordionProceso">
                    <!-- Acordeón 1: Registro y Pago -->
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingRegistro">
                            <button class="accordion-button collapsed" style="background-color:rgb(225, 231, 235); color: black;" type="button" data-bs-toggle="collapse" data-bs-target="#collapseRegistro" aria-expanded="false" aria-controls="collapseRegistro">
                                Etapa 1: Registro y Pago
                            </button>
                        </h2>
                        <div id="collapseRegistro" class="accordion-collapse collapse" aria-labelledby="headingRegistro" data-bs-parent="#accordionProceso">
                            <div class="accordion-body">
                                <p>4 FEBRERO AL 15 DE ABRIL DE 2025</p>
                            </div>
                        </div>
                    </div>

                    <!-- Acordeón 2: Examen de admisión -->
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingExamen">
                            <button class="accordion-button collapsed" style="background-color:rgb(225, 231, 235); color: black;" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExamen" aria-expanded="false" aria-controls="collapseExamen">
                                Etapa 2: Examen de admisión
                            </button>
                        </h2>
                        <div id="collapseExamen" class="accordion-collapse collapse" aria-labelledby="headingExamen" data-bs-parent="#accordionProceso">
                            <div class="accordion-body">
                                <p>18 Y 19 DE JUNIO DE 2025</p>
                            </div>
                        </div>
                    </div>

                    <!-- Acordeón 3: Curso Propedéutico -->
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingCurso">
                            <button class="accordion-button collapsed" style="background-color:rgb(225, 231, 235); color: black;" type="button" data-bs-toggle="collapse" data-bs-target="#collapseCurso" aria-expanded="false" aria-controls="collapseCurso">
                                Etapa 3: Curso Propedéutico
                            </button>
                        </h2>
                        <div id="collapseCurso" class="accordion-collapse collapse" aria-labelledby="headingCurso" data-bs-parent="#accordionProceso">
                            <div class="accordion-body">
                                <p>25 DE JUNIO AL 23 DE JULIO DE 2025</p>
                            </div>
                        </div>
                    </div>

                    <!-- Acordeón 4: Publicación de listas -->
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingListas">
                            <button class="accordion-button collapsed" style="background-color:rgb(225, 231, 235); color: black;" type="button" data-bs-toggle="collapse" data-bs-target="#collapseListas" aria-expanded="false" aria-controls="collapseListas">
                                Etapa 4: Publicación de listas
                            </button>
                        </h2>
                        <div id="collapseListas" class="accordion-collapse collapse" aria-labelledby="headingListas" data-bs-parent="#accordionProceso">
                            <div class="accordion-body">
                                <p>28 DE JULIO 2025</p>
                            </div>
                        </div>
                    </div>
                </div>
