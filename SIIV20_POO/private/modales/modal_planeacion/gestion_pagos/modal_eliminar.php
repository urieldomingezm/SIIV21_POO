        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="alert alert-warning">
                    ...
                    ¿Está seguro de que desea eliminar este registro de pago?
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <p class="mb-2">
                                    <strong><i class="bi bi-person me-1"></i>Nombre:</strong> 
                                    <span id="eliminarNombre" class="text-primary"></span>
                                </p>
                                <p class="mb-2">
                                    <strong><i class="bi bi-card-text me-1"></i>Número de Control:</strong> 
                                    <span id="eliminarNumeroControl" class="text-info"></span>
                                </p>
                                <p class="mb-2">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <p class="mb-0">
                                    <strong><i class="bi bi-percent me-1"></i>Descuento:</strong> 
                                    <span id="eliminarDescuento"></span>
                                </p>
                            </div>
                            <div class="col-md-6">
                                <p class="mb-0">
                                    <strong><i class="bi bi-currency-dollar me-1"></i>Total:</strong> 
                                    <span id="eliminarTotal"></span>
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mt-3">
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="tipoEliminacion" id="eliminacionCompleta" value="completa" checked>
                        <label class="form-check-label" for="eliminacionCompleta">
                    ...
                    <div class="form-check mt-2">
                        <input class="form-check-input" type="radio" name="tipoEliminacion" id="eliminacionSuave" value="suave">
                        <label class="form-check-label" for="eliminacionSuave">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (btnConfirmarEliminar) {
        btnConfirmarEliminar.addEventListener('click', function() {
            ...
            const tipoEliminacion = document.querySelector('input[name="tipoEliminacion"]:checked').value;
            ...
            fetch('private/procesos/planeacion/gestion_pagos/procesar_eliminar.php', {
                method: 'POST',
                body: formData
            })
    ...
    if (modalEliminar) {
        modalEliminar.addEventListener('hidden.bs.modal', function() {
            // Limpiar campos
            const campos = ['eliminarId', 'eliminarNombre', 'eliminarNumeroControl', 'eliminarCarrera', 
                           'eliminarSemestre', 'eliminarPeriodo', 'eliminarDescuento', 'eliminarTotal', 'eliminarEstado'];
            ...
            const eliminacionCompleta = document.getElementById('eliminacionCompleta');
